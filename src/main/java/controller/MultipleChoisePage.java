...
public class MultipleChoisePage extends javax.swing.JFrame {

    public MultipleChoisePage() {
        initComponents();
    }

    public MultipleChoisePage(StudingPage stdP, List<CauHoi> ds, HocVien hv) {
        this.stdP = stdP;
        this.ds = ds;
        this.hv = hv;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(349, 0, -1, -1));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 24, -1, -1));
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 0, -1, -1));
        ...
        jPanel4.add(numQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 6, -1, -1));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/next.jpg"))); // NOI18N
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(793, 0, -1, -1));
        ...
        jPanel4.add(choise1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 238, 379, 42));
        ...
        jPanel4.add(choise4, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 324, 379, 42));
        ...
        jPanel4.add(choise2, new org.netbeans.lib.awtextra.AbsoluteConstraints(497, 238, 379, 42));
        ...
        jPanel4.add(choise3, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 324, 379, 42));
            ...
            case "left" -> {
                if (currentIndexQuestion > 0) {
                    if (currentSelection == null) {
                        ...
                        this.selectedOptions.add(currentSelection);
...
//                this.selectedOptions.add(currentSelecion);
    ...
    public void changeQuestionUI(CauHoi ch) {
        numQuestion.setText(String.format("%d/%d", currentIndexQuestion + 1, ds.size()));
        resetChoises();
        List<MultipleChoise> mtps = ch.getDs();
        mtps.forEach(mtp -> {
            String noidung = mtp.getNoiDung();
            jTextArea1.setText(noidung);
            List<PhuongAn> pa = mtp.getCacPhuongAn();
    ...
    private void btnChoiseOnClick(int index) {
        ...
        currentSelection = currentQuestion.getDs().get(0).getCacPhuongAn().get(index);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultipleChoisePage().setVisible(true);
            }
        });
    }
    ...
    private CauHoi currentQuestion;
    private PhuongAn currentSelection;
