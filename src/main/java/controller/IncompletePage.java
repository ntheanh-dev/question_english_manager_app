...
public class IncompletePage extends javax.swing.JFrame {

    public IncompletePage() {
        initComponents();
    }

    public IncompletePage(StudingPage stdP, Incomplete icp, HocVien hv) {
        this.hv = hv;
        this.stdP = stdP;
        this.icp = icp;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 230, -1, -1));
    ...
    public void init() {
        ...
        jTextArea2.setText(icp.getNoidung());
...
//                this.selectedOptions.add(currentSelecion);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IncompletePage().setVisible(true);
            }
        });
    }

    private HocVien hv;
    private Incomplete icp;
